...
O elemento **FreeBusyAccessLevel** representa a propriedade **FreeBusyAccessLevel** . O elemento **FreeBusyAccessLevel** é apenas para uso interno. Este elemento não é usado pelos clientes. 
