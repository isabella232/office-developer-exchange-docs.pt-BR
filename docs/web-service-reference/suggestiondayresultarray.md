...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[SuggestionsResponse](suggestionsresponse.md) <br/> |Contém informações de resposta e dados de sugestão para sugestões de reunião solicitadas  <br/> Veja a seguir a expressão XPath para este elemento:  <br/>  `/GetUserAvailabilityResponse/SuggestionsResponse` <br/> |
