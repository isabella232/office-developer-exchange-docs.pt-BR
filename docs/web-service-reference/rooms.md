...
O elemento de **salas** é uma lista de um ou mais elementos que representam as salas de reunião. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[Sala](room.md) <br/> |Define um endereço de email e o nome de exibição que representa uma sala de reunião.  <br/> |
