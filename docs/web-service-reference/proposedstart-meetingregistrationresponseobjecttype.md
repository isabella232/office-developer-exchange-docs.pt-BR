...
O elemento **ProposedStart (MeetingRegistrationResponseObjectType)** Especifica que proposto nova hora de início um participante de uma reunião. 
...
O valor de texto do elemento **ProposedStart (MeetingRegistrationResponseObjectType)** é a data de início proposta e a hora da reunião. 
