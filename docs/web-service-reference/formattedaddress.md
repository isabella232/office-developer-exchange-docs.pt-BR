...
O elemento **FormattedAddress** Especifica o valor de exibição formatada do endereço postal associado. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[Valor (PersonaPostalAddressType)](value-personapostaladdresstype.md) <br/> |Especifica informações associadas a um endereço postal.  <br/> |
