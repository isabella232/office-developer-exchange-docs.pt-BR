...
O elemento de **prioridade** indica a ordem na qual uma regra será executada. 
...
O valor de texto para o elemento de **prioridade** é um inteiro que indica a ordem de execução no qual uma regra deve ser executada. 
