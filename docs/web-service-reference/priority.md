...
O elemento **Priority** indica a ordem na qual uma regra deve ser executada. 
...
O valor de texto para o elemento **Priority** é um inteiro que indica a ordem de execução na qual uma regra deve ser executada. 
