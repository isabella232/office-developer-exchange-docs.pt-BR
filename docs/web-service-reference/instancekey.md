...
O elemento **InstanceKey** Especifica uma chave de instância para um item ou conversa. 
...
O valor de texto do elemento **InstanceKey** é a chave de instância de um item ou conversa. 
