...
O elemento **CreateUserConfiguration** representa uma solicitação para criar um objeto de configuração do usuário. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[UserConfiguration](userconfiguration.md) <br/> |Representa um objeto de configuração de usuário único.  <br/> |
