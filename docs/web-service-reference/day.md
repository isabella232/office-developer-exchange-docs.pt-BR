...
O elemento de **dia** representa o dia do mês em que ocorre a transição de fuso horário. 
...
O valor de texto do elemento **dia** é um inteiro que representa o dia do mês em que ocorre a transição de fuso horário. 
