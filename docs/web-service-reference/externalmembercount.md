...
O elemento **ExternalMemberCount** representa a contagem de membros externos em um grupo. 
...
O valor de texto é um inteiro que representa o número de membros externos em um grupo.
