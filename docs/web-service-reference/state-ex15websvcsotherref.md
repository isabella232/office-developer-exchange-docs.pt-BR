...
O elemento de **estado** representa o estado de residência para um item de contato. 
...
Um valor string que representa o nome de um estado é necessário se esse elemento é usado.
