...
---
# <a name="birthday"></a>Aniversário

O elemento de **Aniversário** representa a data de nascimento de um contato. 
...
É necessário um valor de texto que representa uma data e hora.
