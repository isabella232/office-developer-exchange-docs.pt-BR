...
description: O elemento SuppressReadReceipt é usado para suprimir recibos de leitura.
ms.openlocfilehash: d0eb85d4426e59f7484f5d6239702f1e1cf37007
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59531518"
---
# <a name="suppressreadreceipt"></a>SuppressReadReceipt

O **elemento SuppressReadReceipt** é usado para suprimir recibos de leitura. 
