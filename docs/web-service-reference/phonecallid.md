...
|**Attribute**|**Descrição**|
|:-----|:-----|
|Id  <br/> |Identifica a chamada telefônica para desconectar. Este atributo é necessário.  <br/> |
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[DisconnectPhoneCall](disconnectphonecall.md) <br/> |Representa uma solicitação para desconectar chamada.  <br/> |
