...
O elemento **PersonaType** Especifica o tipo de pessoa, por exemplo, uma pessoa ou uma lista de distribuição. 
...
O valor de texto do elemento **PersonaType** é o tipo de pessoa. 
