...
O elemento **personatype** especifica o tipo de persona, por exemplo, uma pessoa ou uma lista de distribuição. 
...
O valor de texto do elemento **personatype** é o tipo de persona. 
