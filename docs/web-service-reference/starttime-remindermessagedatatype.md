...
O elemento **StartTime (ReminderMessageDataType)** Especifica a hora de início do item que o lembrete for para. 
...
O valor de texto do elemento **StartTime (ReminderMessageDataType)** é que a hora de início do item do lembrete se destina. 
