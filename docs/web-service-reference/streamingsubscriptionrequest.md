...
O elemento **StreamingSubscriptionRequest** representa uma assinatura para uma inscrição de notificação de evento streaming. 
...
|**Attribute**|**Descrição**|
|:-----|:-----|
|**SubscribeToAllFolders** <br/> |Indica se o servidor se inscreverá a todas as pastas na caixa de correio do usuário. Um valor **true** indica que o servidor inscreverá.  <br/> |
