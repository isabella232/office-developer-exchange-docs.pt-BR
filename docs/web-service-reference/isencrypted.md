...
O elemento **IsEncrypted** indica se as mensagens de entrada devem ser S/MIME criptografada em ordem para a condição ou uma exceção a ser aplicado. 
...
Um valor de texto de **true** indica que a mensagem deve ser S/MIME criptografada em ordem para a condição ou uma exceção a ser aplicado. Um valor **false** indica que a mensagem não precisa estar S/MIME em ordem para a condição ou uma exceção a ser aplicado. 
