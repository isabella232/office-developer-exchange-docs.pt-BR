...
---
# <a name="userid-string"></a>UserId (cadeia de caracteres)

O elemento **userid** especifica o identificador de usuário de um usuário de email. 
...
O valor de texto do elemento **userid** é um identificador de um usuário de email. 
