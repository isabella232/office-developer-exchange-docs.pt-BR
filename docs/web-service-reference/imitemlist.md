...
O elemento **ImItemList** contém uma lista de contatos de mensagens instantâneas e de grupos de mensagens instantâneos. 
...
[Grupos (ArrayOfImGroupType)](groups-arrayofimgrouptype.md) | [personagens](personas-ex15websvcsotherref.md)
