...
O elemento **UniqueHash** especifica um valor de hash exclusivo usado para eliminação de duplicação. 
...
O valor de texto do elemento **UniqueHash** é um valor de hash usado para eliminação de duplicação. 
