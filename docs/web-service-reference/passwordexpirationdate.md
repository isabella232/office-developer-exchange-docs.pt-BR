...
O elemento **PasswordExpirationDate** fornece a data de expiração de senha para uma conta de caixa de correio. 
...
|:-----|:-----|
|[Operação GetPasswordExpirationDate](getpasswordexpirationdate-operation.md) <br/> |Define uma solicitação para obter a data de expiração de senha para uma conta de email.  <br/> |
