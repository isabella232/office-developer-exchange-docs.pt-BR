...
O elemento **BusinessHomePage** representa a página inicial (endereço da Web) do contato. 
...
O valor de texto representa um URI (Uniform Resource Identifier) para a página inicial.
