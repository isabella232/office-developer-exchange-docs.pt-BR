...
O elemento **BusinessHomePage** representa a Home page (endereço da Web) para o contato. 
...
O valor de texto representa um identificador de recurso uniforme (URI) para a Home page.
