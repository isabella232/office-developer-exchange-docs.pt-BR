...
description: O elemento GetFederatedDirectoryUser destina-se apenas ao uso interno.
...
O **elemento GetFederatedDirectoryUser** destina-se apenas ao uso interno. 
