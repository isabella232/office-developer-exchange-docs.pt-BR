...
O elemento **BccRecipient** representa um destinatário para receber uma cópia carbono oculta (Cco) de uma mensagem de email. 
...
Esse elemento pode ser **true** ou **false**. Um valor **true** indica que o destinatário está cego carbono copiado; um valor **false** indica que o destinatário não é copiado de carbono deficientes Visual. 
