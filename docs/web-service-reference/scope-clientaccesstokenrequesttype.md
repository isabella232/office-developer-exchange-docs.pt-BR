...
O elemento de **escopo (ClientAccessTokenRequestType)** Especifica um escopo de token. 
...
O valor de texto do elemento **escopo (ClientAccessTokenRequestType)** é um escopo de token. 
