...
O elemento **PersonaId** Especifica o identificador de pessoa para a pessoa associada. 
...
|ChangeKey  <br/> |O valor de texto do atributo **ChangeKey** é a chave de alteração da pessoa.  <br/> |
...
[GetPersona](getpersona.md) | [pessoa](persona.md)
