...
O elemento **RefreshSharingFolder** define uma solicitação para atualizar a pasta local especificada. É o elemento base para a [operação RefreshSharingFolder](refreshsharingfolder-operation.md).
