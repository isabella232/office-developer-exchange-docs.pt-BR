...
O elemento **CcRecipients** representa uma coleção de destinatários que receberá uma cópia da mensagem. 
...
Você não pode obter **CcRecipients** usando uma solicitação FindItem. Use uma solicitação GetItem para obter o **CcRecipients**.
