...
O elemento **EwsUrl** Especifica a URL da instância do ponto de extremidade recomendada para o Exchange Web Services (EWS) para um usuário habilitado para email. 
...
O **EwsUrl** é um elemento filho opcionais do elemento de **protocolo** . 
