...
description: O elemento GlobalUniqueUnreadSenders especifica uma lista de todas as pessoas que enviaram mensagens que estão atualmente não lidas nesta conversa em todas as pastas da caixa de correio.
ms.openlocfilehash: 4aa886fd817cc8bda7f9a8922b8303bf304e153b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59547355"
---
# <a name="globaluniqueunreadsenders"></a>GlobalUniqueUnreadSenders

O **elemento GlobalUniqueUnreadSenders** especifica uma lista de todas as pessoas que enviaram mensagens que estão atualmente não lidas nesta conversa em todas as pastas da caixa de correio. 
