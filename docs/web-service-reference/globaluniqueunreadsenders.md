...
O elemento **GlobalUniqueUnreadSenders** especifica uma lista de todas as pessoas que enviaram mensagens não lidas atualmente nesta conversa em todas as pastas da caixa de correio. 
