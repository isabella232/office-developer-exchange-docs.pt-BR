...
O elemento de **AddNewImContactToGroupResponse** define uma resposta a uma solicitação **AddNewImContactToGroup** . 
...
[MessageText](messagetext.md) | [ResponseCode](responsecode.md) | [DescriptiveLinkKey](descriptivelinkkey.md) | [MessageXml](messagexml.md) | [pessoa](persona.md)
