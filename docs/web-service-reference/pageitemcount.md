...
O elemento **PageItemCount** Especifica o número de páginas retornados em uma paginação de resultados de pesquisa. 
...
O valor de texto do elemento **PageItemCount** é o número de páginas retornados em uma paginação de resultados de pesquisa. 
