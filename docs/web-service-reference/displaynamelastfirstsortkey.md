...
O elemento **DisplayNameLastFirstSortKey** contém a chave de classificação para um nome de exibição em Sobrenome, nome ordem. 
...
O valor de texto do elemento **DisplayNameLastFirstSortKey** é a chave de classificação para o nome da pessoa em Sobrenome, nome ordem. 
