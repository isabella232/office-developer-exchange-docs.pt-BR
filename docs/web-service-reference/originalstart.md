...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[CalendarItem](calendaritem.md) <br/> |Representa um item de calendário no Exchange store.  <br/> |
...
Um valor de texto que representa uma data e hora é necessário se esse elemento for usado.
