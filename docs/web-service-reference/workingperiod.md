...
O elemento **WorkingPeriod** contém a semana de trabalho dias e horas do usuário da caixa de correio. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[DayOfWeek (WorkingPeriod)](dayofweek-workingperiod.md) <br/> |Contém a lista de dias úteis agendados para o usuário de caixa de correio.  <br/> |
|[StartTimeInMinutes](starttimeinminutes.md) <br/> |Representa o início do dia útil para um usuário de caixa de correio.  <br/> |
|[EndTimeInMinutes](endtimeinminutes.md) <br/> |Representa o final do dia útil para um usuário de caixa de correio.  <br/> |
