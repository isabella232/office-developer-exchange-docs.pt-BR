...
description: O elemento ItemIds contém uma matriz de identificadores de item que identificam os itens a exportar de uma caixa de correio.
ms.openlocfilehash: 3009bf1f7012e62e21d019530cd7eac1bbbcb8a7
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59522825"
---
# <a name="itemids-nonemptyarrayofitemidstype"></a>ItemIds (NonEmptyArrayOfItemIdsType)

O **elemento ItemIds** contém uma matriz de identificadores de item que identificam os itens a exportar de uma caixa de correio. 
