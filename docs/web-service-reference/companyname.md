...
description: O elemento CompanyName representa o nome da empresa associado a um contato.
...
O **elemento CompanyName** representa o nome da empresa associado a um contato. 
