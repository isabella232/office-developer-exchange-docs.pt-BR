...
O elemento **PhoneticFullName** contém o nome completo de um contato, incluindo o nome e sobrenome, escrito foneticamente. 
...
O valor de texto é uma cadeia de caracteres que representa o nome completo de um contato, incluindo o nome e sobrenome, escrito foneticamente.
