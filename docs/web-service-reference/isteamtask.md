...
ms.locfileid: "59529777"
---
# <a name="isteamtask"></a>IsTeamTask

O **elemento IsTeamTask** indica se a tarefa pertence a uma equipe. 
...
O valor de texto representa um valor Boolean que indica se uma tarefa pertence a uma equipe. Esta é uma propriedade somente leitura.
