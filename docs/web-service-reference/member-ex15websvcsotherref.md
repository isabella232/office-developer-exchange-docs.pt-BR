...
O elemento de **membro** representa um membro de uma lista de distribuição. 
...
|**Attribute**|**Descrição**|
|:-----|:-----|
|Tecla  <br/> |Fornece um identificador exclusivo para o membro da lista de distribuição. Este atributo é opcional.  <br/> |
