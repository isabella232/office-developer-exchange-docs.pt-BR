...
---
# <a name="hostname-soap"></a>O nome de host (SOAP)

O elemento **Hostname** representa a parte do nome de host do nome completo do computador do computador. 
...
O valor de texto do elemento **Hostname** é a parte do nome de host do nome completo do computador do computador. 
