...
O elemento **SearchFilter** contém a cadeia de caracteres de consulta para filtrar as caixas de correio a serem retornados em uma solicitação de **GetSearchableMailboxes** . 
