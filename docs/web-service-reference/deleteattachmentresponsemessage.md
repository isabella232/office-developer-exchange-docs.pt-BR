...
O elemento **DeleteAttachmentResponseMessage** contém o status e o resultado de uma única [operação DeleteAttachment](deleteattachment-operation.md) solicitação. 
...
|**Attribute**|**Descrição**|
|:-----|:-----|
|**ResponseClass** <br/> | Descreve o status de uma resposta [DeleteAttachment operação](deleteattachment-operation.md) .<br/><br/>Os seguintes valores são válidos para este atributo:<br/><br/>-Êxito  <br/>-Aviso  <br/>-Erro  <br/> |
