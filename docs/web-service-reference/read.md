...
description: O elemento Read indica se um cliente pode ler uma pasta ou item. Esse elemento foi introduzido no Microsoft Exchange Server 2007 Service Pack 1 (SP1).
ms.openlocfilehash: f86d7c415065b6cb45492f66cca55c6f3d7f466d
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59527653"
---
# <a name="read"></a>Ler

O **elemento Read** indica se um cliente pode ler uma pasta ou item. Esse elemento foi introduzido no Microsoft Exchange Server 2007 Service Pack 1 (SP1). 
...
Um valor de texto **true** indica que um cliente pode ler um item de pasta. 
