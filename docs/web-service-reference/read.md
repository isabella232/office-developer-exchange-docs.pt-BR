...
O elemento **Read** indica se um cliente pode ler uma pasta ou item. Este elemento foi introduzido no Microsoft Exchange Server 2007 Service Pack 1 (SP1). 
...
Um valor **true** indica que um cliente pode ler um item de pasta. 
