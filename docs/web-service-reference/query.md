...
O elemento de **consulta** contém a consulta de pesquisa para a retenção. 
...
O valor de texto do elemento de **consulta** é a cadeia de caracteres de consulta de pesquisa para uma pesquisa de descoberta. 
