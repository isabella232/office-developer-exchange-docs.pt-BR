...
O elemento **ProxySuggesterSid** é usado pelo proxy HTTP do computador que está executando o Microsoft Exchange Server 2007 que tenha acesso para cliente a função de servidor instalada e não é usada por operações de serviços Web do Exchange. Este elemento foi introduzido no Exchange Server 2007 Service Pack 1 (SP1). 
