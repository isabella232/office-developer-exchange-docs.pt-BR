...
O elemento **IsFromMe** indica se um usuário que enviou um item para si mesmo. 
...
Um valor de texto de **true** indica que o item foi enviado por um usuário para si mesmo. Um valor **false** indica que o item não foi enviado pelo usuário para si mesmo. 
