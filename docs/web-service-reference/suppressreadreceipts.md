...
O elemento **SuppressReadReceipts** indica se ler confirmações devem ser suprimidas. 
...
Um valor de texto de **true** para o elemento **SuppressReadReciepts** indica read confirmações são suprimidas. Um valor **false** indica que são lidas confirmações serão enviadas ao remetente. 
