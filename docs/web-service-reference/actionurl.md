...
O elemento **ActionUrl** identifica a URL que o usuário deve navegar, para corrigir um problema indicado pelo elemento [AppStatus](appstatus-ex15websvcsotherref.md) . 
...
O valor de texto do elemento **ActionUrl** identifica a URL que o usuário deve navegar, para corrigir um problema indicado pelo elemento **AppStatus** . 
