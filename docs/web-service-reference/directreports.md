...
O elemento **DirectReports** contém informações de SMTP que identifica os funcionários subordinados de um contato. 
...
|:-----|:-----|
|[Contato](contact.md) <br/> |Representa o item no armazenamento do Exchange de contato.  <br/> |
