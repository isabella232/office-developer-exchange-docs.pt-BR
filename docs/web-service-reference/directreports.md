...
O elemento **DirectReports** contém informações SMTP que identificam os subordinados diretos de um contato. 
...
|:-----|:-----|
|[Contato](contact.md) <br/> |Representa o item de contato no repositório do Exchange.  <br/> |
