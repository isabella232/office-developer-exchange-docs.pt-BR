...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[Sugestão](suggestion.md) <br/> |Representa uma sugestão de reunião único.  <br/> |
   
### <a name="parent-elements"></a>Elementos pai

|**Elemento**|**Descrição**|
|:-----|:-----|
|[SuggestionDayResult](suggestiondayresult.md) <br/> |Representa um único dia que contém os horários de reunião sugeridas.  <br/> Este é a expressão XPath para esse elemento:  <br/>  `/GetUserAvailabilityResponse/SuggestionsResponse/SuggestionDayResultArray/SuggestionDayResult[i]` <br/> |
