...
description: O elemento IsReadReceiptRequested indica se o remetente de um item solicita um recibo de leitura.
ms.openlocfilehash: 0ecc70116512103c252692295bd61fd102d7b5ea
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59524137"
---
# <a name="isreadreceiptrequested"></a>IsReadReceiptRequested

O **elemento IsReadReceiptRequested** indica se o remetente de um item solicita um recibo de leitura. 
...
Um valor de texto **true** indica que um recibo de leitura é solicitado ao destinatário do item. 
  
## <a name="remarks"></a>Comentários

Se **IsReadReceiptRequested** for **true**, a configuração [de IsRead](isread.md) como **true** envia um recibo de leitura. O destinatário pode suprimir recibos de leitura enviando o objeto de resposta [SuppressReadReceipt](suppressreadreceipt.md) antes de definir a **propriedade IsRead.** 
