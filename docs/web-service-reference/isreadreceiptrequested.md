...
Um valor de texto **true** indica que uma confirmação de leitura é solicitada do destinatário do item. 
  
## <a name="remarks"></a>Comentários

Se **IsReadReceiptRequested** for **true**, a definição de [IsRead](isread.md) como **true** enviará uma confirmação de leitura. O destinatário pode suprimir as confirmações de leitura enviando o objeto de resposta [SuppressReadReceipt](suppressreadreceipt.md) antes de definir a propriedade **IsRead** . 
