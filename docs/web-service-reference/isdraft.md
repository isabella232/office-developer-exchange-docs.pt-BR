...
Um valor de texto que representa um valor booliano é necessário. Um valor **true** indica que uma mensagem ainda não foi enviada. Um valor **false** indica que uma mensagem foi enviada. 
