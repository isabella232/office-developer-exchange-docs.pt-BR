...
---
# <a name="size-long"></a>Tamanho (longo)

O elemento **size** especifica o tamanho total de um ou mais itens de caixa de correio. 
...
O valor de texto do elemento **size** é o tamanho total de um ou mais itens de caixa de correio. 
