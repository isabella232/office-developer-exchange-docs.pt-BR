...
---
# <a name="size-long"></a>Tamanho (long)

O elemento de **tamanho** Especifica o tamanho total de um ou mais itens de caixa de correio. 
...
O valor de texto do elemento de **tamanho** é o tamanho total de um ou mais itens de caixa de correio. 
