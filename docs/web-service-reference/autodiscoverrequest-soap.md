...
O elemento **AutodiscoverRequest** representa o elemento base de todas as solicitações de descoberta automática. 
...
O elemento global **AutodiscoverRequest** nunca é usado. 
