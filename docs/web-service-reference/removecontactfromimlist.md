...
O elemento **RemoveContactFromImList** representa uma solicitação para remover um contato de todos os grupos de mensagens instantâneos de mensagens instantâneas. 
