...
O elemento **Descrição** Especifica o texto descritivo para a política de retenção. 
...
O valor de texto do elemento **Descrição** é um valor de cadeia de caracteres que descreve a política de retenção. 
