...
O elemento **SortValue** Especifica um valor usado para a classificação. 
...
O valor de texto do elemento [SortValue](sortvalue.md) é o campo usado para classificar o conjunto de resultados. 
