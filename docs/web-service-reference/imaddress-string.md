...
---
# <a name="imaddress-string"></a>IMAddress (cadeia de caracteres)

O elemento **IMAddress** contém o endereço de mensagens instantâneas principal de uma pessoa. 
...
O valor de texto do elemento **IMAddress** é o endereço de mensagens instantâneas principal de uma pessoa. 
