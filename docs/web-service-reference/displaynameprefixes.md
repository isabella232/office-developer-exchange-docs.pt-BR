...
O elemento **DisplayNamePrefixes** especifica uma matriz de prefixos de nome de exibição e os identificadores de suas atribuições de origem para o persona associado. 
