...
---
# <a name="timezone-item"></a>Fuso horário (Item)

O elemento **TimeZone** fornece uma descrição de texto de um fuso horário. 
...
O valor de texto descreve um fuso horário. Esta propriedade é somente leitura.
