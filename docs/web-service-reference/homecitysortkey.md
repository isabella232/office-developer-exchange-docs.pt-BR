...
O elemento **HomeCitySortKey** representa a chave de classificação da cidade inicial. 
...
O valor de texto do elemento **HomeCitySortKey** é a chave de classificação para o nome de cidade da pessoa de casa. 
