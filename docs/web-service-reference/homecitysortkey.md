...
O elemento **HomeCitySortKey** representa a chave de classificação da cidade residencial. 
...
O valor de texto do elemento **HomeCitySortKey** é a chave de classificação para o nome da cidade residencial da pessoa. 
