...
O elemento **ProposedStart (AttendeeType)** Especifica o horário de início proposta de um participante de uma reunião. 
...
O valor de texto do elemento **ProposedStart (AttendeeType)** é uma data de início proposta e o horário de uma reunião. 
