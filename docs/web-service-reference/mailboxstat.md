...
O elemento **MailboxStat** Especifica as estatísticas de uma caixa de correio pesquisada por pesquisa de descoberta. 
...
[MailboxId](mailboxid.md) | [DisplayName (string)](displayname-string.md) | [ItemCount](itemcount.md) | [tamanho (long)](size-long.md)
