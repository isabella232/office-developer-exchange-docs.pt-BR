...
O elemento **OtherFaxes** Especifica uma matriz de valores de número de telefone de fax e os identificadores de suas atribuições de origem para a pessoa associada. 
