...
---
# <a name="name-message-tracking"></a>Nome (rastreamento de mensagens)

O elemento **Name** representa o nome da propriedade para um relatório de controle de mensagens. 
