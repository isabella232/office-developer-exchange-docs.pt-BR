...
O elemento **ExportItemsResponseMessage** contém o status e os resultados de uma solicitação para exportar um item de caixa de correio única. 
...
|[Dados (base64Binary)](data-base64binary.md) <br/> |Contém o conteúdo de um item exportado.  <br/> |
