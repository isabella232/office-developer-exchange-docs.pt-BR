...
O elemento **PhoneticLastName** contém o sobrenome de um contato, escritas foneticamente. 
...
O valor de texto é uma cadeia de caracteres que representa o sobrenome de um contato, escritas foneticamente.
