...
O elemento **PhoneticLastName** contém o sobrenome de um contato, escrito foneticamente. 
...
O valor de texto é uma cadeia de caracteres que representa o último nome de um contato, escrito foneticamente.
