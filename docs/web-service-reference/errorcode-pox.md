...
O elemento de **ErrorCode** contém o código de erro para um erro de resposta de descoberta automática. 
...
O valor de texto representa o código de erro para um erro de resposta de descoberta automática.
