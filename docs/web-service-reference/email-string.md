...
O elemento de **Email** identifica o endereço de email do usuário cuja foto é solicitada na operação **GetUserPhoto** . 
...
O valor de texto do elemento de **Email** é o endereço de email do usuário cuja foto é solicitada na operação GetUserPhoto. 
