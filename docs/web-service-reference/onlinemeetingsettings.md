...
O elemento **OnlineMeetingSettings** especifica as configurações para reuniões online. 
...
[LobbyBypass](lobbybypass.md)  |  [AccessLevel](accesslevel.md)  |  [Apresentadores](presenters.md)
