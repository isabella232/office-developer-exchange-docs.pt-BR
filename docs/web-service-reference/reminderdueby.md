...
description: O elemento ReminderDueBy representa a data e a hora em que o evento ocorre. Isso é usado pelo elemento ReminderMinutesBeforeStart para determinar quando o lembrete é exibido.
...
O **elemento ReminderDueBy** representa a data e a hora em que o evento ocorre. Isso é usado pelo [elemento ReminderMinutesBeforeStart](reminderminutesbeforestart.md) para determinar quando o lembrete é exibido. 
...
O valor do texto representa a data e a hora em que um lembrete é devido.
