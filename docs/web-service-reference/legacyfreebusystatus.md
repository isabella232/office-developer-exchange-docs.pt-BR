...
O elemento **LegacyFreeBusyStatus** representa o status livre/ocupado do item de calendário. 
...
Um valor de texto é necessário para esse elemento. Estes são os valores de texto possíveis para esse elemento:
