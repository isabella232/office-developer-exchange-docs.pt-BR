...
---
# <a name="referenceid"></a>ID de referência

O elemento de **ID de referência** Especifica o identificador de referência da caixa de correio. 
...
O valor de texto do elemento de **ID de referência** é o identificador de referência de uma caixa de correio. 
