...
O elemento **PhoneNumbers** representa uma coleção de números de telefone para um contato. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[Entrada (PhoneNumber)](entry-phonenumber.md) <br/> |Representa um número de telefone de um contato.  <br/> |
