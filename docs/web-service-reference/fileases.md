...
description: O elemento FileAses especifica uma matriz de elementos StringAttributedValue e os identificadores de suas atribuições de origem para a persona associada.
ms.openlocfilehash: 349a16063167f8c716169443acc42a0851f5e545
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59535231"
---
# <a name="fileases"></a>FileAses

O **elemento FileAses** especifica uma matriz de elementos **StringAttributedValue** e os identificadores de suas atribuições de origem para a persona associada. 
