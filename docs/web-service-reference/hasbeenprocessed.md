...
O elemento **HasBeenProcessed** indica se uma mensagem de reunião item foi processada. 
...
Um valor de texto de **true** indica que a mensagem de reunião foi processada. 
