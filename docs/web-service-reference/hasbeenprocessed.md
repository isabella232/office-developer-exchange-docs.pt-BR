...
O elemento **HasBeenProcessed** indica se um item de mensagem de reunião foi processado. 
...
Um valor de texto **true** indica que a mensagem de reunião foi processada. 
