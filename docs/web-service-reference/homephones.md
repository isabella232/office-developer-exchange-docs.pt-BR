...
O elemento **HomePhones** especifica uma matriz de números de telefone residenciais e os identificadores de suas atribuições de origem para o persona associado. 
