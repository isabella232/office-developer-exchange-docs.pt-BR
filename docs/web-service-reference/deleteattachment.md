...
O elemento **DeleteAttachment** é o elemento raiz em uma solicitação para excluir um anexo do armazenamento do Exchange. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[AttachmentIds](attachmentids.md) <br/> |Contém uma matriz de identificadores de anexos que são usados para excluir os anexos.  <br/> |
