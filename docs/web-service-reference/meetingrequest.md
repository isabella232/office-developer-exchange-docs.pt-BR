...
O elemento **MeetingRequest** representa uma solicitação de reunião no repositório do Exchange. 
...
|[DateTimeReceived](datetimereceived.md) <br/> |Representa os dados e a hora em que um item foi recebido em uma caixa de correio.  <br/> |
...
|[ResponseType](responsetype.md) <br/> |Representa o tipo de resposta de destinatário que é recebida para uma reunião.  <br/> |
...
|[When](when.md) <br/> |Fornece uma descrição de quando uma reunião ocorre.  <br/> |
...
|[ConflictingMeetingCount](conflictingmeetingcount.md) <br/> |Representa o número de reuniões que entram em conflito com a solicitação de reunião.  <br/> |
...
|[ModifiedOccurrences](modifiedoccurrences.md) <br/> |Contém uma matriz de ocorrências de itens de calendário recorrentes que foram modificadas para que sejam diferentes do item mestre de recorrência.  <br/> Este elemento é válido se [CalendarItemType](calendaritemtype.md) tiver o valor RecurringMaster.  <br/> |
...
|[AllowNewTimeProposal](allownewtimeproposal.md) <br/> |Indica se um novo horário de reunião pode ser proposto para uma reunião.  <br/> |
