...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[WorkingPeriod](workingperiod.md) <br/> |Contém os dias da semana de trabalho e as horas do usuário da caixa de correio.  <br/> |
   
### <a name="parent-elements"></a>Elementos pai

|**Elemento**|**Descrição**|
|:-----|:-----|
|[WorkingHours](workinghours-ex15websvcsotherref.md) <br/> |Representa as configurações de fuso horário e o horário de trabalho para o usuário de caixa de correio solicitado.  <br/> Veja a seguir a expressão XPath para este elemento:  <br/>  `/GetUserAvailabilityResponse/FreeBusyResponseArray/FreeBusyResponse/FreeBusyView/WorkingHours` <br/> |
   
## <a name="remarks"></a>Comentários

Esse elemento será necessário se o [elemento WorkingHours](workinghours-ex15websvcsotherref.md) for usado. Todos os elementos filho são listados na sequência em que ocorrem. 
