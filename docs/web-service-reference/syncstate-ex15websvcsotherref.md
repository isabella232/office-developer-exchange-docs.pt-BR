...
O elemento **SyncState** contém uma forma codificada em base64 dos dados de sincronização que são atualizados após cada solicitação bem-sucedida. Isso é usado para identificar o estado de sincronização. 
...
Um valor de texto é obrigatório quando esse elemento é usado.
