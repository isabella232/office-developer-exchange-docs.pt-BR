...
O elemento **ProxyPartnerToken** é usado pelo proxy HTTP do computador que está executando o Microsoft Exchange Server 2010 que tem a função de servidor acesso para cliente instalada. Este elemento não é usado pelas operações de serviços Web do Exchange (EWS). 
