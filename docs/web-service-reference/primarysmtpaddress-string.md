...
O elemento **PrimarySmtpAddress** Especifica o endereço de Simple Mail Transfer Protocol (SMTP) principal da caixa de correio. 
...
[UserId (string)](userid-string.md) | [caixa de correio (PreviewItemMailboxType)](mailbox-previewitemmailboxtype.md) | [SearchableMailbox](searchablemailbox.md)
