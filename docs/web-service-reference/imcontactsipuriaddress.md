...
O elemento **ImContactSipUriAddress** contém o endereço de URI do SIP de um contato que é adicionado a um grupo (IM) de mensagens instantâneas. 
...
O valor de texto do elemento **ImContactSipUriAddress** é o endereço de URI do SIP de um contato. 
