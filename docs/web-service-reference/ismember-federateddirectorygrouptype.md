...
description: O elemento IsMember (FederatedDirectoryGroupType) destina-se apenas ao uso interno.
...
O **elemento IsMember (FederatedDirectoryGroupType)** destina-se apenas ao uso interno. 
