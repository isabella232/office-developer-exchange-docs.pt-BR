...
O elemento **CopyItemResponseMessage** contém o status e o resultado de uma única [operação CopyItem](copyitem-operation.md) solicitação. 
...
|**Attribute**|**Descrição**|
|:-----|:-----|
|**ResponseClass** <br/> | Descreve o status de uma resposta [CopyItem operação](copyitem-operation.md) .<br/><br/>Os seguintes valores são válidos para este atributo:<br/><br/>-Êxito  <br/>-Aviso  <br/>-Erro  <br/> |
...
|[Items](items.md) <br/> |Contém uma matriz de itens copiados  <br/> |
