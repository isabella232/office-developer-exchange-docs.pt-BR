...
|[EncryptedSharedFolderDataCollection](encryptedsharedfolderdatacollection.md) <br/> |Contém uma coleção de estruturas de dados que um cliente pode usar para autorizar o compartilhamento de seu calendário ou dados de contato com outros clientes.  <br/> |
|[InvalidRecipients](invalidrecipients.md) <br/> |Representa destinatários da solicitação de compartilhamento de pastas inválidas.  <br/> |
