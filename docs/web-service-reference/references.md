...
O elemento **References** representa o cabeçalho da Usenet que é usado para associar respostas com as mensagens originais. 
...
O valor de texto representa um cabeçalho da Usenet.
