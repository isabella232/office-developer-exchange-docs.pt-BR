...
description: O elemento References representa o header Usenet usado para associar respostas às mensagens originais.
ms.openlocfilehash: a0889ed9ef7b96a2b2a78b9333b03f8efaafaf1f
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59523633"
---
# <a name="references"></a>Referências

O **elemento References** representa o header Usenet usado para associar respostas às mensagens originais. 
...
O valor de texto representa um header usenet.
