...
O elemento [WebClientUrlCollectionSetting (SOAP)](webclienturlcollectionsetting-soap.md) representa um usuário de configuração que é uma coleção de URLs de cliente da Web do Exchange. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[WebClientUrl (SOAP)](webclienturl-soap.md) <br/> |Representa a URL de um cliente da Web do Exchange.  <br/> |
