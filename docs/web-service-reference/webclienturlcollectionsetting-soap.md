...
O elemento [WebClientUrlCollectionSetting (SOAP)](webclienturlcollectionsetting-soap.md) representa uma configuração de usuário que é uma coleção de URLs de cliente Web do Exchange. 
