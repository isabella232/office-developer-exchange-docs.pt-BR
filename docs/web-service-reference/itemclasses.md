...
description: O elemento ItemClasses representa as classes de item que devem ser carimbadas em mensagens de entrada para que a condição ou exceção seja aplicada.
ms.openlocfilehash: a04c773d40d199902de7a7963e02444ed1def4fa
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59511424"
---
# <a name="itemclasses"></a>ItemClasses

O **elemento ItemClasses** representa as classes de item que devem ser carimbadas em mensagens de entrada para que a condição ou exceção seja aplicada. 
