...
O elemento de **aniversários** Especifica uma matriz de aniversários, armazenados como cadeias de caracteres e os identificadores de suas atribuições de origem para a pessoa associada. 
