...
O elemento **YomiCompanyNames** Especifica uma matriz de nomes de empresa japonês fonética e os identificadores de suas atribuições de origem para a pessoa associada. 
