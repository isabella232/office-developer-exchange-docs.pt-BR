...
O elemento **AuthenticationMethods** descreve os métodos de autenticação que estão disponíveis para um cliente da Web. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[WebClientUrl (SOAP)](webclienturl-soap.md) <br/> |Representa a URL do cliente do Outlook Web App.  <br/> |
   
## <a name="text-value"></a>Valor de texto

O valor de texto do elemento **AuthenticationMethods** é a URL do cliente do Outlook Web App. 
