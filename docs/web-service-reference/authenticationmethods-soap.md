...
O elemento **AuthenticationMethods** descreve os métodos de autenticação que estão disponíveis para um cliente Web. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[WebClientUrl (SOAP)](webclienturl-soap.md) <br/> |Representa a URL do cliente Outlook Web App.  <br/> |
   
## <a name="text-value"></a>Text value

O valor de texto do elemento **AuthenticationMethods** é a URL do cliente Outlook Web App. 
