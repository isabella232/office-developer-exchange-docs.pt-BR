...
O elemento **FromConnectedAccounts** representa os nomes de conta de email dos quais as mensagens de entrada precisam ter sido agregadas para que a condição ou exceção seja aplicada. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[String](string.md) <br/> |Representa um nome de conta de email a partir do qual as mensagens de entrada precisam ser agregadas para que a condição ou exceção seja aplicada.  <br/> |
