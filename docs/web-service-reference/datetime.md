...
O elemento de **DateTime** representa a data e hora em que ocorre a transição de fuso horário. 
...
O valor de texto do elemento **DateTime** representa a data e hora em que ocorre a transição de fuso horário. 
