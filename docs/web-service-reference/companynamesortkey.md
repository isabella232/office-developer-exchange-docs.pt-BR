...
O elemento **CompanyNameSortKey** contém a chave de classificação para um nome de empresa. 
...
O valor de texto do elemento **CompanyNameSortKey** é a chave de classificação para um nome de empresa. 
