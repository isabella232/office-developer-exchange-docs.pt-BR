...
O elemento **GroupType** Especifica a classe de grupo de um grupo (IM) de mensagens instantâneas. 
...
O valor de texto do elemento **GroupType** é um valor string que especifica o tipo de grupo. 
