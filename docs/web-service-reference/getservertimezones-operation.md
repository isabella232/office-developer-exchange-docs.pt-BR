...
A operação **GetServerTimeZones** pode usar os cabeçalhos SOAP listados e descritos na tabela a seguir. 
...
## <a name="getservertimezones-request-examples"></a>Exemplos de solicitação GetServerTimeZones

### <a name="getting-the-name-and-identifier-of-each-time-zone"></a>Obtendo o nome e o identificador de cada fuso horário

O exemplo de código a seguir mostra como recuperar o nome e o identificador para o horário padrão da costa leste e fuso horário padrão do Pacífico.
...
Cada elemento [ID (TimeZone)](id-timezone.md) contém o identificador de uma definição de fuso horário que está sendo solicitada. Para solicitar informações de todos os fusos horários, omita o elemento [IDs](ids.md) da solicitação. 
  
### <a name="getting-the-full-definition-of-each-time-zone"></a>Obtendo a definição completa de cada fuso horário

O exemplo de código a seguir mostra como recuperar a definição de fuso horário completo do fuso horário padrão do leste.
...
### <a name="receiving-the-time-zone-name-and-identifier-only"></a>Recebendo somente o nome e o identificador de fuso horário

O exemplo a seguir de uma resposta **GetServerTimeZones** mostra uma resposta bem-sucedida a uma solicitação **GetServerTimeZones** na qual o atributo **ReturnFullTimeZoneData** foi definido como **false**. A resposta contém o nome e o identificador para o horário padrão da costa leste e fuso horário padrão do Pacífico.
...
O exemplo a seguir de uma resposta **GetServerTimeZones** mostra uma resposta bem-sucedida a uma solicitação **GetServerTimeZones** na qual o atributo **ReturnFullTimeZoneData** foi definido como **true**. A resposta contém a definição de fuso horário completo do fuso horário padrão do leste da costa.
