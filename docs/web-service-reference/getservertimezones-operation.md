...
description: A operação GetServerTimeZones retorna informações das definições de fuso horário disponíveis em um servidor Exchange.
ms.openlocfilehash: f46222251729d5e82042f267d4b6293afb16de00
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59516948"
---
...
### <a name="getting-the-name-and-identifier-of-each-time-zone"></a>Obter o Nome e o Identificador de Cada Fuso Horário
...
Cada [elemento ID (TimeZone)](id-timezone.md) contém o identificador de uma definição de fuso horário que está sendo solicitada. Para solicitar informações para todos os fusos horário, omita o elemento [Ids](ids.md) da solicitação. 
  
### <a name="getting-the-full-definition-of-each-time-zone"></a>Obter a Definição Completa de Cada Fuso Horário
...
### <a name="receiving-the-time-zone-name-and-identifier-only"></a>Recebendo somente o nome e o identificador do fuso horário
