...
---
# <a name="getservertimezones-operation"></a>Operação GetServerTimeZones

A operação **GetServerTimeZones** retorna informações de definições de fuso horário que estão disponíveis em um servidor Exchange. 
  
## <a name="soap-headers"></a>Cabeçalhos SOAP

A operação **GetServerTimeZones** pode usar os cabeçalhos SOAP que estão listados e descritos na tabela a seguir. 
...
## <a name="getservertimezones-request-examples"></a>Exemplos de solicitação de GetServerTimeZones

### <a name="getting-the-name-and-identifier-of-each-time-zone"></a>Obtendo o nome e o identificador de cada fuso horário

O exemplo de código a seguir mostra como recuperar o nome e o identificador para o fuso horário hora padrão do Leste e hora oficial do Pacífico.
...
Cada elemento de [Id (TimeZone)](id-timezone.md) contém o identificador de uma definição de fuso horário que está sendo solicitado. Para solicitar informações de todos os fusos horários, omita o elemento [Ids](ids.md) da solicitação. 
  
### <a name="getting-the-full-definition-of-each-time-zone"></a>Obtendo a definição completa de cada fuso horário

O exemplo de código a seguir mostra como recuperar a definição de fuso horário completo para o fuso horário de hora padrão do Leste.
...
## <a name="getservertimezones-response-examples"></a>Exemplos de resposta GetServerTimeZones

### <a name="receiving-the-time-zone-name-and-identifier-only"></a>Receber o nome do fuso horário e o identificador somente

O exemplo a seguir de uma resposta **GetServerTimeZones** mostra uma resposta bem-sucedida a uma solicitação de **GetServerTimeZones** no qual o atributo **ReturnFullTimeZoneData** foi definido como **false**. A resposta conterá o nome e o identificador para o fuso horário hora padrão do Leste e hora oficial do Pacífico.
...
### <a name="receiving-a-full-time-zone-definition"></a>Recebendo uma definição de fuso horário completo

O exemplo a seguir de uma resposta **GetServerTimeZones** mostra uma resposta bem-sucedida a uma solicitação de **GetServerTimeZones** no qual o atributo **ReturnFullTimeZoneData** foi definido como **true**. A resposta conterá a definição de fuso horário completo para o fuso horário de hora padrão do Leste.
