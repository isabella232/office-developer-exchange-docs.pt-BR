...
O elemento **Value** representa um valor de configuração do usuário. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[Usersetting (SOAP)](usersetting-soap.md) <br/> |Representa o elemento base de todas as configurações do usuário.  <br/> |
|[DomainSetting (SOAP)](domainsetting-soap.md) <br/> |Representa o elemento base de todas as configurações de domínio.  <br/> |
