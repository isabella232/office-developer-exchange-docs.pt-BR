...
O elemento de **valor** representa um valor de configuração do usuário. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[UserSetting (SOAP)](usersetting-soap.md) <br/> |Representa o elemento base para todas as configurações de usuário.  <br/> |
|[DomainSetting (SOAP)](domainsetting-soap.md) <br/> |Representa o elemento base para todas as definições de domínio.  <br/> |
