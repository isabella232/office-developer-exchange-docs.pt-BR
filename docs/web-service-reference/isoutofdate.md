...
O elemento **IsOutOfDate** indica se uma mensagem de reunião, solicitação, resposta ou cancelamento está desatualizado. 
...
Um valor de texto de **true** indica que o item de reunião está desatualizado. 
