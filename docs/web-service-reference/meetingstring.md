...
O elemento **MeetingString** Especifica o nome da reunião como resultado de extração de entidade. 
...
O valor de texto para o elemento **MeetingString** é o nome da reunião. 
