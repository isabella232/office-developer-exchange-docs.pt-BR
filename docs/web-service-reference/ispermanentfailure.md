...
Um valor de texto **true** para o elemento **IsPermanentFailure** indica que uma tentativa anterior de indexar o item da caixa de correio não foi bem sucedida. Um valor **false** indica que uma tentativa anterior de indexar o item da caixa de correio foi bem-sucedida. 
