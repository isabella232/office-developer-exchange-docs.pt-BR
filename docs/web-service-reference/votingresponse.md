...
O elemento **VotingResponse** Especifica a votação enviada. Esse elemento só estará presente em respostas a mensagens de solicitação de votação, não em respostas para aprovações. 
...
O valor de texto do elemento **VotingResponse** é a votação enviada. 
