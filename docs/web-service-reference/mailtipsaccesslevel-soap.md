...
O elemento **MailTipsAccessLevel** representa a propriedade **MailTipsAccessLevel** . O elemento **MailTipsAccessLevel** é apenas para uso interno. Este elemento não é usado pelos clientes. 
