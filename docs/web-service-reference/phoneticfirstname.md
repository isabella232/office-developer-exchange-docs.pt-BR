...
O elemento **PhoneticFirstName** contém o nome de um contato, escritas foneticamente. 
...
O valor de texto é uma cadeia de caracteres que representa o nome de um contato, escritas foneticamente.
