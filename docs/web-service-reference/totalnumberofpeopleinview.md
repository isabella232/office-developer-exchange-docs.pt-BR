...
O elemento **TotalNumberOfPeopleInView** Especifica o número total de personagens retornados em uma resposta **FindPeople** . 
...
O valor de texto do elemento **TotalNumberOfPeopleInView** é o número total de personagens retornados em uma resposta **FindPeople** . 
