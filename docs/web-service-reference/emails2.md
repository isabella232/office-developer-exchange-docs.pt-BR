...
description: O elemento Emails2 contém uma matriz de valores EmailAddressAttributedValue e os identificadores de suas atribuições de origem para a persona associada.
ms.openlocfilehash: 4f72dc160607bc2b92d25c9e62ea5a73d5f8fc6a
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59520784"
---
# <a name="emails2"></a>Emails2

O **elemento Emails2** contém uma matriz de **valores EmailAddressAttributedValue** e os identificadores de suas atribuições de origem para a persona associada. 
