...
O elemento **UserRoles** Especifica as funções de usuário que o usuário ou o usuário que o aplicativo de parceiro chamada está atuando como, quer aplicar para a chamada atual. 
