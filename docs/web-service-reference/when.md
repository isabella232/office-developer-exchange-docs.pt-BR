...
O elemento **quando** fornece informações sobre quando ocorre um calendário ou item de reunião. 
...
O valor de texto é uma cadeia de caracteres que descreve quando ocorre a um item do calendário.
