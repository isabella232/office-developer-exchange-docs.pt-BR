...
O elemento **YomiLastNames** especifica uma matriz de sobrenome fonéticos japoneses e os identificadores de suas atribuições de origem para o persona associado. 
