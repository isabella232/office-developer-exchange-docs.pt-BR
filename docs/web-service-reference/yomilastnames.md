...
O elemento **YomiLastNames** Especifica uma matriz de nomes de últimos japonês fonéticas e os identificadores de suas atribuições de origem para a pessoa associada. 
