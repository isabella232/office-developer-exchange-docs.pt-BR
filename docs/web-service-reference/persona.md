...
---
# <a name="persona"></a><span data-ttu-id="15a72-103">Pessoa</span><span class="sxs-lookup"><span data-stu-id="15a72-103">Persona</span></span>

<span data-ttu-id="15a72-104">O elemento de **pessoa** Especifica um conjunto de dados de pessoa retornados por uma solicitação **GetPersona** .</span><span class="sxs-lookup"><span data-stu-id="15a72-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
