...
description: O elemento persona especifica um conjunto de dados persona retornados por uma solicitação getpersona.
ms.openlocfilehash: 093b346300b5fdcbfb31f2e1240d57d9476e250a
ms.sourcegitcommit: 88ec988f2bb67c1866d06b361615f3674a24e795
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 05/31/2020
ms.locfileid: "44465874"
---
# <a name="persona"></a><span data-ttu-id="80383-103">Pessoal</span><span class="sxs-lookup"><span data-stu-id="80383-103">Persona</span></span>

<span data-ttu-id="80383-104">O elemento **persona** especifica um conjunto de dados persona retornados por uma solicitação **getpersona** .</span><span class="sxs-lookup"><span data-stu-id="80383-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
