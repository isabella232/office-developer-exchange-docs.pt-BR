...
---
# <a name="persona"></a>Pessoal

O elemento **persona** especifica um conjunto de dados persona retornados por uma solicitação **getpersona** . 
...
[AddNewImContactToGroupResponse](addnewimcontacttogroupresponse.md)  |  [AddNewTelUriContactToGroupResponse](addnewteluricontacttogroupresponse.md)  |  [GetPersonaResponseMessage](getpersonaresponsemessage.md)  |  [Pessoas](people.md)  |  [Pessoas](personas-ex15websvcsotherref.md)
