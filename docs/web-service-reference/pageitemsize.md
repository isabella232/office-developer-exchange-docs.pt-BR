...
O elemento **PageItemSize** Especifica o número de itens para retornar em uma paginação de resultados de pesquisa. 
...
O valor de texto do elemento **PageItemSize** é o número de itens retornados em uma paginação de resultados de pesquisa. 
