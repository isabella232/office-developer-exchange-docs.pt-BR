...
O elemento **PageItemSize** especifica o número de itens a serem retornados em uma paginação de resultado de pesquisa. 
...
O valor de texto do elemento **PageItemSize** é o número de itens retornados em uma paginação de resultado de pesquisa. 
