...
O elemento **LastAttemptTime** contém a hora e data em que a última tentativa para indexar o item foi feita. 
...
O valor de texto do elemento **LastAttemptTime** representa uma hora e data em que a última tentativa para indexar o item foi feita. 
