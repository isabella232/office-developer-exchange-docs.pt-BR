...
O elemento **IndexedOffset** indica o deslocamento de índice para uma resposta de **FindConversation** paginado. 
...
O valor de texto do elemento **IndexedOffset** é o deslocamento de índice da página para **FindConversation** respostas. 
