...
O elemento **EcpUrl-publicar** Especifica uma URL parcial que pode ser combinada com o valor do elemento [EcpUrl POX ()](ecpurl-pox.md) para gerar uma URL que pode ser usada para acessar as configurações para um usuário habilitado para email de publicação de calendário. 
...
O **EcpUrl-publicar** é um elemento filho opcionais do elemento de **protocolo** . 
