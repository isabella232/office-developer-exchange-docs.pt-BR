...
O elemento **MaxItemsToReturn** identifica o número máximo de itens de conversas a serem retornados em uma resposta **GetConversationItems** . 
...
O valor de texto do elemento **MaxItemsToReturn** é o número máximo de itens de conversa a serem retornados em uma resposta. 
