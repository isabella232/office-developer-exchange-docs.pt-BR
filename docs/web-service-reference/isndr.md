...
O elemento **IsNDR** indica se as mensagens de entrada devem ser notificações de falha na entrega (NDRs) para que a condição ou exceção seja aplicada. 
...
Um valor de texto **true** indica que a mensagem deve ser um NDR para que a condição ou exceção seja aplicada. Um valor **false** indica que a mensagem não deve ser um NDR para que a condição ou exceção seja aplicada. 
