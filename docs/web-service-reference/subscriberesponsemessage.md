...
O elemento **SubscribeResponseMessage** contém o status e o resultado de uma única solicitação [Subscribe operação](subscribe-operation.md) . 
...
|**Attribute**|**Descrição**|
|:-----|:-----|
|**ResponseClass** <br/> | Descreve o status de uma [operação Subscribe](subscribe-operation.md) de resposta. <br/><br/>Os seguintes valores são válidos para este atributo:  <br/><br/>-Êxito  <br/>-Aviso  <br/>-Erro  <br/> |
