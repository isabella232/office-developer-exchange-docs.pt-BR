...
O elemento de **servidor** representa o servidor de caixa de correio alternativo. 
...
O valor de texto do elemento de **servidor** é o nome do servidor de caixa de correio alternativo. 
