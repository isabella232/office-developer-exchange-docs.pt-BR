...
description: O elemento GivenName contém o nome dado de um contato.
ms.openlocfilehash: b102c6137c597da15217e65bdc0a68fdac1cd305
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59525915"
---
# <a name="givenname"></a>GivenName

O **elemento GivenName** contém o nome dado de um contato. 
...
Um valor de texto que representa o nome dado de um contato é necessário se esse elemento for usado.
  
## <a name="remarks"></a>Comentários

Um nome determinado geralmente é o primeiro nome de uma pessoa.
