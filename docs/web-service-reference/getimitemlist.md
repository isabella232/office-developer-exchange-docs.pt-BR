...
description: O elemento GetImItemList define uma solicitação para obter uma lista de grupos e contatos de mensagens instantâneas.
...
O **elemento GetImItemList** define uma solicitação para obter uma lista de grupos e contatos de mensagens instantâneas. 
