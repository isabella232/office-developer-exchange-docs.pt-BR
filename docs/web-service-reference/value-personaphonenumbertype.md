...
O elemento de **valor** Especifica uma telefone número e digite as informações e é associado a um conjunto de atribuições. 
...
[Número](number.md) | [tipo (string)](type-string.md)
