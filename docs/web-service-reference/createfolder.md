...
O elemento de **CreateFolder** define uma solicitação para criar uma pasta no repositório do Exchange. 
...
|[Pastas](folders-ex15websvcsotherref.md) <br/> |O elemento que contém todas as pastas para criar.  <br/> |
