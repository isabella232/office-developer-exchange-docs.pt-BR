...
O elemento **EcpUrl-tmCreating** Especifica uma URL parcial que pode ser combinada com o valor do elemento [EcpUrl POX ()](ecpurl-pox.md) para gerar uma URL que pode ser usada para criar uma nova caixa de correio do site. 
...
O valor de texto representa uma URL parcial que pode ser combinada com o valor do elemento [EcpUrl POX ()](ecpurl-pox.md) para gerar uma URL que pode ser usada para criar uma nova caixa de correio do site. 
  
## <a name="remarks"></a>Coment�rios

O **EcpUrl-tmCreating** é um elemento filho opcionais do elemento de **protocolo** . 
