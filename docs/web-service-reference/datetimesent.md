...
O elemento **DateTimeSent** representa a data e hora em que um item em uma caixa de correio foi enviado. 
...
O valor de texto representa a data e hora em que um item foi enviado.
