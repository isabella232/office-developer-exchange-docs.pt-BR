...
O elemento de **FlagStatus** contém o status do sinalizador agregados para itens de conversa na pasta atual. 
...
O valor de texto do elemento **FlagStatus** é o status do sinalizador agregados para itens de conversa na pasta atual. Estes são os valores de texto possíveis: 
