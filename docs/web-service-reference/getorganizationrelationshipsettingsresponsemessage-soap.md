...
O elemento de **GetOrganizationRelationshipSettingsResponseMessage** define uma resposta a uma solicitação de [operação GetOrganizationRelationshipSettings (SOAP)](getorganizationrelationshipsettings-operation-soap.md) . O elemento **GetOrganizationRelationshipSettingsResponseMessage** é apenas para uso interno. Este elemento não é usado pelos clientes. 
