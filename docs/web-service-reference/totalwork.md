...
O elemento de trabalho **total** contém uma descrição de quanto trabalho está associado a uma tarefa. 
...
O valor de texto corresponde a um inteiro que representa a quantidade total de trabalho associada a uma tarefa.
