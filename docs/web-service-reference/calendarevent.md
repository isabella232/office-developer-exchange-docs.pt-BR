...
O elemento **CalendarEvent** representa uma ocorrência de item de calendário exclusivo. 
...
|[BusyType](busytype.md) <br/> |Representa o status livre/ocupado definido para um evento de calendário. Este é um elemento filho obrigatório.  <br/> |
|[CalendarEventDetails](calendareventdetails.md) <br/> |Fornece informações adicionais para um evento de calendário. Este é um elemento filho opcionais.  <br/> |
