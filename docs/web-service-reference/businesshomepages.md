...
description: O elemento BusinessHomePages especifica uma matriz de home pages de negócios e os identificadores de suas atribuições de origem para a persona associada.
ms.openlocfilehash: b8382681bd0abebcff2ddaec67d56cbe568e07f0
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59543573"
---
# <a name="businesshomepages"></a>BusinessHomePages

O **elemento BusinessHomePages** especifica uma matriz de home pages de negócios e os identificadores de suas atribuições de origem para a persona associada. 
