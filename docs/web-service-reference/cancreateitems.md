...
description: O elemento CanCreateItems indica se um usuário tem permissão para criar itens em uma pasta. Esse elemento foi introduzido no Microsoft Exchange Server 2007 Service Pack 1 (SP1).
...
O **elemento CanCreateItems** indica se um usuário tem permissão para criar itens em uma pasta. Esse elemento foi introduzido no Microsoft Exchange Server 2007 Service Pack 1 (SP1). 
