...
O elemento **HasStartTimeChanged** Especifica se a hora de início para uma reunião foi alterada. 
...
Um valor de texto de **true** para o elemento **HasStartTimeChanged** indica que a hora de início para uma reunião foi alterado. Um valor **false** indica que a hora de início não tiver sido alterado. 
