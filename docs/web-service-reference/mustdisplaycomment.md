...
O valor de texto representa um valor Boolean. Um valor **true** indica que o comentário deve ser exibido; um valor de **false** indica que o comentário não precisa ser exibido. 
