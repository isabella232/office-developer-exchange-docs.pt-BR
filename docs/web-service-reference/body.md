...
|Istruncado  <br/> |Valor booliano que indica se o corpo está truncado.  <br/> |
...
|Texto  <br/> |Indica que o corpo está no texto.  <br/> |
...
O valor de texto do elemento **Body** é o corpo de conteúdo do item. 
