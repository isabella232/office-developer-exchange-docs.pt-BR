...
O elemento **OriginalDisplayName** contém o nome para exibição associado a um endereço de email original. 
...
O valor de texto do elemento **OriginalDisplayName** é o nome para exibição associado a um endereço de email original. 
