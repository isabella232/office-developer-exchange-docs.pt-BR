...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[GetUserAvailabilityResponse](getuseravailabilityresponse.md) <br/> |Contém as informações de disponibilidade dos usuários solicitados.  <br/> Veja a seguir a expressão XPath para este elemento:  <br/>  `/GetUserAvailabilityResponse` <br/> |
   
## <a name="remarks"></a>Comentários

Esse elemento não será incluído em uma resposta GetUserAvailability [se SuggestionsViewOptions](suggestionsviewoptions.md) não estiver definido na mensagem de solicitação GetUserAvailability. 
