...
O elemento **TemplateName** Especifica o nome do modelo de gerenciamento de direitos. 
...
O valor de texto do elemento **TemplateName** é o nome do modelo de gerenciamento de direitos aplicado a um item. 
