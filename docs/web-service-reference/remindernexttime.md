...
O elemento **ReminderNextTime** especifica a data e a hora para o próximo lembrete. 
...
O valor de texto para o elemento **ReminderNextTime** é a data e a hora do próximo lembrete agendado. 
