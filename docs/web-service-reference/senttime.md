...
---
# <a name="senttime"></a>Hora de envio

O elemento de **hora de envio** Especifica a hora em que o item foi enviado. 
...
O valor de texto do elemento de **hora de envio** é a data e hora em que um item foi enviado. 
