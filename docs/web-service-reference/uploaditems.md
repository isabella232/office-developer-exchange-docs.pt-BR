...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[Items (NonEmptyArrayOfUploadItemsType)](items-nonemptyarrayofuploaditemstype.md) <br/> |Contém uma matriz de itens para carregar em uma caixa de correio.  <br/> |
