...
O elemento **IsRecurring** indica se um item de calendário, solicitação de reunião ou tarefa é parte de um item recorrente. Este elemento é somente leitura. 
...
|**Tipo de CalendarItem**|**Organizador <br/> (IsRecurring)**|**Participante <br/> (IsRecurring)**|**Atualizar/solicitação de reunião <br/> (IsRecurring)**|
|:-----|:-----|:-----|:-----|
...
O valor da propriedade **IsRecurring** que está definido para itens de calendário mestre recorrentes para o organizador está incorreto; Este valor deve ser definido como **TRUE**. 
