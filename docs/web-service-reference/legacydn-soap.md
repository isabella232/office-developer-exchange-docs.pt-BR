...
O elemento **LegacyDN** representa o nome distinto herdado de caixa de correio alternativo. 
...
O valor do elemento **LegacyDN** é o nome diferenciado herdado de caixa de correio alternativo. 
