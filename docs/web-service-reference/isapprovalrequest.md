...
O elemento **IsApprovalRequest** indica se as mensagens de entrada devem ser solicitações de aprovação em ordem para a condição ou uma exceção a ser aplicado. 
...
Um valor de texto de **true** indica que a mensagem deve ser uma solicitação de aprovação em ordem para a condição ou uma exceção a ser aplicado. Um valor **false** indica que a mensagem não deve ser uma solicitação de aprovação em ordem para a condição ou uma exceção a ser aplicado. 
