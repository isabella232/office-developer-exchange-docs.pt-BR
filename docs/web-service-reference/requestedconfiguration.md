...
O elemento **RequestedConfiguration** contém as configurações do serviço solicitado. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[ConfigurationName](configurationname.md) <br/> |Especifica as configurações de serviço solicitado pelo nome.  <br/> |
