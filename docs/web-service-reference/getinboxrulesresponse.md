...
O **elemento GetInboxRulesResponse** define uma resposta a uma solicitação de operação [GetInboxRules.](getinboxrules-operation.md) 
...
|**Atributo**|**Descrição**|
|:-----|:-----|
|**ResponseClass** <br/> | Descreve o status de uma resposta de [operação GetInboxRules.](getinboxrules-operation.md) <br/><br/>Os seguintes valores são válidos para este atributo: <br/> <br/>- Sucesso  <br/>- Aviso  <br/>- Erro  <br/> |
...
|[OutlookRuleBlobExists](outlookruleblobexists.md) <br/> |Indica se existe um blob Outlook regra da Microsoft na caixa de correio do usuário.  <br/> |
