...
---
# <a name="notes-contact"></a>Notas (contato)

O elemento de **anotações** contém as informações de contato suplementares. 
...
O valor de texto é uma cadeia de caracteres que representa as informações de contato suplementares.
