...
O elemento **ApprovalDecisionTime** especifica a hora em que a decisão de aprovação foi feita. 
...
O valor de texto do elemento **ApprovalDecisionTime** representa a hora e a data em que a decisão de aprovação foi feita. 
