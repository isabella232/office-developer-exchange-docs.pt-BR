...
O elemento **GetSharingFolderResponseMessage** contém o status e o resultado de uma única solicitação de [operação de GetSharingFolder](getsharingfolder-operation.md) . 
