...
O elemento de **Contatos** contém uma lista de contatos que estão associados uma tarefa. 
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[String](string.md) <br/> |Representa uma lista separada por vírgulas de nomes de contato.  <br/> |
