...
---
# <a name="entryid-um-web-service"></a>EntryID (serviço Web da UM)

O elemento **EntryID** contém o valor que representa o identificador do item a ser tocado no telefone em uma solicitação de [operação do PlayOnPhone (serviço Web da um)](playonphone-operation-um-web-service.md) . 
  
[PlayOnPhone (serviço Web da UM)](playonphone-um-web-service.md)
  
[EntryID (serviço Web da UM)](entryid-um-web-service.md)
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[PlayOnPhone (serviço Web da UM)](playonphone-um-web-service.md) <br/> |Define uma solicitação para reproduzir um item em um telefone.  <br/> |
