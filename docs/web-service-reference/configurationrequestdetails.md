...
O elemento **ConfigurationRequestDetails** contém o estado de cliente para pedidos de atenção de política. As informações de estado podem incluir as regras que são instaladas e a versão do componente de cliente. 
...
Os elementos filhos não estão definidos no esquema de serviços Web do Exchange.
