...
ms.locfileid: "59542853"
---
# <a name="refreshsharingfolderresponsemessage"></a>RefreshSharingFolderResponseMessage

O **elemento RefreshSharingFolderResponseMessage** contém o status e o resultado de uma única solicitação de operação [RefreshSharingFolder.](refreshsharingfolder-operation.md) 
