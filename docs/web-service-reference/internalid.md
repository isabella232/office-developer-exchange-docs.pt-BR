...
O elemento **InternalId** representa um valor inteiro para a identificação de evento. 
...
Se este elemento for usado, será necessário um valor de texto que representa um número inteiro.
