...
---
# <a name="scope-highlighttermtype"></a>Escopo (HighlightTermType)

O elemento de **escopo** Especifica a cadeia de caracteres a ser realçada. 
...
O valor de texto do elemento **escopo** é o escopo de um termo realçado. 
