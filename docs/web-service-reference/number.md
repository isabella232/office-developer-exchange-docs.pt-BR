...
O elemento de **número** Especifica um número de telefone. 
...
O valor de texto do elemento **número** é um número de telefone representado no formato de cadeia de caracteres. 
