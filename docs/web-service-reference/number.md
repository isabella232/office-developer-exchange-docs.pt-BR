...
O elemento **Number** especifica um número de telefone. 
...
O valor de texto do elemento **Number** é um número de telefone representado no formato de cadeia de caracteres. 
