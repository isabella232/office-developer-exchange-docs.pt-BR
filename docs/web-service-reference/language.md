...
O elemento de **idioma** contém o idioma usado para a consulta de pesquisa. 
...
O valor de texto do elemento de **idioma** é o idioma usado em uma pesquisa de descoberta. 
