...
O elemento **IsSubmitted** indica se um item foi enviado à pasta padrão caixa de saída. 
...
Um valor de texto de **true** indica que o item foi enviado para a pasta caixa de saída. 
