...
---
# <a name="issubmitted"></a>Isenviado

O elemento **isenviado** indica se um item foi enviado para a pasta padrão da ' a '. 
...
Um valor de texto **true** indica que o item foi enviado para a pasta de saída. 
