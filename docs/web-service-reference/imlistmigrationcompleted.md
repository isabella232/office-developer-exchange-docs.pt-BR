...
O elemento **ImListMigrationCompleted** indica se o armazenamento do Exchange contém a itens usados por clientes de mensagens instantâneas de mensagens instantâneas. 
