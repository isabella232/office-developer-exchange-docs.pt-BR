...
O elemento **TargetSharingEpr** representa a propriedade **TargetSharingEpr** . O elemento **TargetSharingEpr** é apenas para uso interno. Este elemento não é usado pelos clientes. 
