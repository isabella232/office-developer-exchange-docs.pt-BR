...
O elemento de **Id** identifica a definição de um único fuso horário. 
...
É necessário um valor de texto. O valor de texto representa o identificador exclusivo para a definição de fuso horário.
