...
O elemento **Duration** representa a duração de um item do calendário. 
...
O valor de texto representa a duração de um item do calendário. Essa propriedade é somente leitura.
