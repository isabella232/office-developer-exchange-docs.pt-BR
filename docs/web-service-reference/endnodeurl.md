...
O elemento **EndNodeUrl** Especifica a URL para o aplicativo de email no Office Store. 
...
O valor de texto do elemento **EndNodeUrl** é a URL para o aplicativo de email no Office Store. 
