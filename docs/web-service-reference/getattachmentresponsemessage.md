...
|**Atributo**|**Descrição**|
|:-----|:-----|
|**ResponseClass** <br/> | Descreve o status de uma [resposta de operação GetAttachment.](getattachment-operation.md)<br/><br/> Os seguintes valores são válidos para este atributo: <br/> <br/>- Sucesso  <br/>- Aviso  <br/>- Erro  <br/> |
...
|[Anexos](attachments-ex15websvcsotherref.md) <br/> |Contém os itens ou arquivos que são separados a um item no Exchange store.  <br/> |
