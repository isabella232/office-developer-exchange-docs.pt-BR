...
O elemento **GetAttachmentResponseMessage** contém o status e o resultado de uma única [operação GetAttachment](getattachment-operation.md) solicitação. 
...
|**Attribute**|**Descrição**|
|:-----|:-----|
|**ResponseClass** <br/> | Descreve o status de uma resposta [GetAttachment operação](getattachment-operation.md) .<br/><br/> Os seguintes valores são válidos para este atributo: <br/> <br/>-Êxito  <br/>-Aviso  <br/>-Erro  <br/> |
...
|[Anexos](attachments-ex15websvcsotherref.md) <br/> |Contém os itens ou arquivos que estão ttached a um item no armazenamento do Exchange.  <br/> |
