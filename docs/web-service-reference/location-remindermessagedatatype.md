...
O elemento **Location (ReminderMessageDataType)** Especifica o local do que o lembrete for para o item do calendário. 
...
O valor de texto do elemento **local** é o local do item de calendário. 
