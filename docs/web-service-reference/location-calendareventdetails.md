...
Um valor de texto será necessário se esse elemento for retornado na resposta. Esse elemento pode conter uma cadeia de caracteres vazia. Esse elemento será opcional se o [elemento CalendarEventDetails](calendareventdetails.md) for usado. 
  
## <a name="remarks"></a>Comentários

Esse elemento mapeia para uma propriedade PR_Location MAPI nomeada.
