...
O elemento **Location** representa o campo local do item do calendário. 
...
Um valor de texto será necessário se esse elemento for retornado na resposta. Este elemento pode conter uma cadeia de caracteres vazia. Este elemento é opcional se o elemento [CalendarEventDetails](calendareventdetails.md) for usado. 
  
## <a name="remarks"></a>Comentários

Este elemento mapeia para uma propriedade nomeada PR_Location MAPI.
