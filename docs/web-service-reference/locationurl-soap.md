...
O elemento **LocationUrl** representa a URL de um documento local de compartilhamento. 
...
O valor de texto do elemento **LocationUrl** é a URL de um documento local de compartilhamento. 
