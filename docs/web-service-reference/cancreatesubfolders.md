...
Um valor de texto de **true** indica que o usuário pode criar subpastas na pasta. Um valor **false** indica que o usuário não é possível criar subpastas na pasta. 
