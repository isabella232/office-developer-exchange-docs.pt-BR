...
|[EndDate (Recurrence)](enddate-recurrence.md) <br/> |Representa a data final de um item de calendário ou tarefa recorrente.  <br/> |
...
|[Recurrence (TaskRecurrenceType)](recurrence-taskrecurrencetype.md) <br/> |Contém o padrão de recorrência para tarefas recorrentes.  <br/> |
