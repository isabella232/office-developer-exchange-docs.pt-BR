...
O elemento **ManagedByOrganization** Especifica a organização de gerenciamento. 
...
O valor de texto do elemento **ManagedByOrganization** identifica a organização que gerencia a pesquisa de descoberta. 
