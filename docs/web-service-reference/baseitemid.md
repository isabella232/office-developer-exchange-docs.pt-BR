...
O elemento **BaseItemId** representa a classe base para IDs que representam os itens em uma caixa de correio. Esta é uma classe abstrata e, portanto, não ocorrerá em um documento de instância. 
...
Este elemento é um tipo de base abstrato para identificadores de item. Este elemento não é usado em chamadas de serviço Web.
