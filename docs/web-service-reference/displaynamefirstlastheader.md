...
O elemento **DisplayNameFirstLastHeader** especifica o cabeçalho para o nome de exibição, primeiro nome. 
...
O valor de texto do elemento **DisplayNameFirstLastHeader** é um valor String que especifica o cabeçalho. 
