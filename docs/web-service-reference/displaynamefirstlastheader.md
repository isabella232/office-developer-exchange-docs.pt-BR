...
description: O elemento DisplayNameFirstLastHeader especifica o header para o nome de exibição, primeiro nome.
ms.openlocfilehash: a40b8f80ff4000cd2eeb33db33d23f6640719773
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59535523"
---
# <a name="displaynamefirstlastheader"></a>DisplayNameFirstLastHeader

O **elemento DisplayNameFirstLastHeader** especifica o header para o nome de exibição, primeiro nome. 
...
O valor de texto do **elemento DisplayNameFirstLastHeader** é um valor de cadeia de caracteres que especifica o header. 
