...
---
# <a name="inreplyto"></a>Inresponderto

O elemento **InReplyTo** representa o identificador do item para o qual este item é uma resposta. 
...
O valor de texto representa uma cadeia de caracteres que identifica um item.
