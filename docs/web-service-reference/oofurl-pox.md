...
O elemento **OOFUrl** Especifica a URL da instância melhor do que o serviço de disponibilidade para um usuário habilitado para email. 
...
O valor de texto Especifica a URL do servidor de configuração de ausência temporária para uma topologia do Exchange.
