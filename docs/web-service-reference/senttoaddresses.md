...
O elemento **SentToAddresses** indica os endereços de email para os quais as mensagens de entrada precisam ter sido enviadas para que a condição ou exceção seja aplicada. 
