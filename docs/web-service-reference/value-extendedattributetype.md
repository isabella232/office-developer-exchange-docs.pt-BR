...
description: O elemento Value (ExendedAttributeType) destina-se apenas ao uso interno.
...
O **elemento Value (ExendedAttributeType)** destina-se apenas ao uso interno. 
