...
O elemento **ContactString** Especifica o nome de exibição de um contato. 
...
O valor de texto do elemento **ContactString** é o valor de cadeia de caracteres que especifica o nome para exibição. 
