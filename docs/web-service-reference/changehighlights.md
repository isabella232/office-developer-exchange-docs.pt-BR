...
O elemento **ChangeHighlights** Especifica o que mudou entre duas versões de uma reunião mensagem de solicitação. 
...
|[HasStartTimeChanged](hasstarttimechanged.md) <br/> |Especifica se a hora de início para uma reunião foi alterada.  <br/> |
|[Start](start.md) <br/> |Representa o início de uma duração.  <br/> |
|[HasEndTimeChanged](hasendtimechanged.md) <br/> |Especifica se a hora de término para uma reunião foi alterada.  <br/> |
