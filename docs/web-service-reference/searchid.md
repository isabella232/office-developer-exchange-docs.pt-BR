...
ms.locfileid: "59543986"
---
# <a name="searchid"></a>SearchId

O **elemento SearchId** especifica o identificador de uma pesquisa de descoberta. 
...
O valor de texto do **elemento SearchId** é o identificador de pesquisa de descoberta. 
