...
O elemento **OriginalPhoneString** especifica o número de telefone original de um contato ou de uma pessoa. 
...
O valor de texto do elemento **OriginalPhoneString** é o número de telefone original de um contato ou de uma pessoa. 
