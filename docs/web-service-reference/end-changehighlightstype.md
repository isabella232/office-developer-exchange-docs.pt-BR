...
O elemento **final** Especifica as alterações feitas em uma reunião quando uma atualização de reunião ocorre de hora de término. 
...
O valor de texto do elemento **final** é a nova hora de término de uma reunião. 
