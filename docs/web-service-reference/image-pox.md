...
O elemento de **imagem** contém o caminho de uma imagem que é usado para marcar a experiência de configuração. 
...
O valor de texto representa o caminho de uma imagem que é usado para marcar a experiência de configuração.
