...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[ID (TimeZone)](id-timezone.md) <br/> |O elemento que identifica uma única definição de fuso horário.  <br/> |
   
### <a name="parent-elements"></a>Elementos pai

|**Elemento**|**Descrição**|
|:-----|:-----|
|[GetServerTimeZones](getservertimezones.md) <br/> |Define uma solicitação para recuperar definições de fuso horário do Exchange Server.  <br/> |
