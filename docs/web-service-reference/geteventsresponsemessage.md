...
O elemento **GetEventsResponseMessage** contém o status e o resultado de uma única [operação GetEvents](getevents-operation.md) solicitação. 
...
|**Attribute**|**Descrição**|
|:-----|:-----|
|**ResponseClass** <br/> | Descreve o status de uma resposta [GetEvents operação](getevents-operation.md) . <br/><br/>Os seguintes valores são válidos para este atributo: <br/> <br/>-Êxito  <br/>-Aviso  <br/>-Erro  <br/> |
