...
O elemento **ContentExpiryDate** Especifica a data de validade do conteúdo. 
...
O valor de texto do elemento **ContentExpiryDate** é uma cadeia de caracteres que especifica a data de validade do conteúdo. 
