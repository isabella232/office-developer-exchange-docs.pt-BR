...
description: Encontre informações sobre a operação CreateFolderPath EWS.
ms.openlocfilehash: cd4a96e5c16bc006c9202f224b2bdd677fb23a93
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59538426"
---
# <a name="createfolderpath-operation"></a>Operação CreateFolderPath

Encontre informações sobre a **operação CreateFolderPath** EWS. 
...
A **solicitação de operação CreateFolderPath** leva uma matriz de pastas e um identificador de pasta pai e cria uma hierarquia de pastas com base na ordem das pastas na matriz. 
  
### <a name="createfolderpath-operation-soap-headers"></a>Headers SOAP da operação CreateFolderPath

A **operação CreateFolderPath** pode usar os headers SOAP listados na tabela a seguir. 
...
|**TimeZoneContext** <br/> |[TimeZoneContext](timezonecontext.md) <br/> |Identifica o escopo do fuso horário para as **propriedades DateTime.** Esse header é aplicável a uma solicitação.  <br/> |
...
O exemplo a seguir de uma solicitação de operação **CreateFolderPath** mostra como criar uma hierarquia de pastas com três pastas no fundo da pasta de Caixa de Entrada padrão. 
...
## <a name="successful-createfolderpath-operation-response"></a>Resposta bem-sucedida da operação CreateFolderPath

O exemplo a seguir mostra uma resposta bem-sucedida a uma solicitação de operação **CreateFolderPath** para criar uma hierarquia de pastas três pastas profundas na pasta de Caixa de Entrada padrão. 
...
## <a name="createfolderpath-operation-error-response"></a>Resposta de erro da operação CreateFolderPath

O exemplo a seguir mostra uma resposta de erro a uma **solicitação de operação CreateFolderPath.** Esta é uma resposta a uma solicitação para criar duas pastas, a primeira das quais não tem um conjunto de propriedades de nome de exibição. A primeira pasta na hierarquia não pode ser criada sem uma propriedade de nome de exibição, e a segunda pasta não pode ser criada porque a pasta pai na hierarquia não foi criada. 
