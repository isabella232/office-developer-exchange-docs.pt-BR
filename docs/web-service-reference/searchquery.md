...
O elemento **SearchQuery** especifica a consulta de pesquisa de descoberta. 
...
O valor de texto do elemento **SearchQuery** é uma cadeia de caracteres de consulta de pesquisa. 
