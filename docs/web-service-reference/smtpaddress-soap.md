...
O elemento **SmtpAddress** representa a endereço SMTP da caixa de correio alternativa. 
...
O valor de texto do elemento **SmtpAddress** é o endereço de email SMTP da caixa de correio alternativo. 
