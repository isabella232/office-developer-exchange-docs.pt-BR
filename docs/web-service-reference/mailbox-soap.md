...
O elemento de **caixa de correio** contém o endereço de email do usuário a ser descoberto. 
...
O valor de texto do elemento de **caixa de correio** é o endereço de email do usuário a ser descoberto. 
