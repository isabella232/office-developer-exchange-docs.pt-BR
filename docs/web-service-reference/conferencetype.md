...
O elemento **ConferenceType** descreve o tipo de conferência que for executado com um item de calendário. 
...
Se este elemento for usado, será necessário um valor de texto que representa um valor inteiro. Estes são os valores possíveis para esse elemento:
