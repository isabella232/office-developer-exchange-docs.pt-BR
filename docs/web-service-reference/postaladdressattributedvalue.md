...
O elemento **PostalAddressAttributedValue** Especifica uma instância de uma matriz de endereços postais e suas atribuições associadas. 
...
[Valor (PersonaPostalAddressType)](value-personapostaladdresstype.md) | [atribuições (ArrayOfValueAttributionsType)](attributions-arrayofvalueattributionstype.md)
