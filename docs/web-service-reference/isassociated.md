...
O elemento **isassociated** indica se o item está associado a uma pasta. 
...
Um valor de texto **true** indica que o item está associado a uma pasta; um valor **false** indica que o item não está associado a uma pasta. 
