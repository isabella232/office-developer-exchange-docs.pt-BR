...
O valor de texto Especifica se o logon seguro é necessário. Se não for especificado, o valor padrão é definido para **ativado**. Os valores possíveis são **Ativar** e **Desativar**.
