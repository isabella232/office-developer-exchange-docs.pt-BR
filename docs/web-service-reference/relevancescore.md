...
O elemento **RelevanceScore** especifica um inteiro que representa o quão relevante o persona associado é para o cliente. 
...
O valor de texto do elemento **RelevanceScore** é a determinação do quão relevante é uma pessoa para o cliente. Este elemento é somente leitura. 
