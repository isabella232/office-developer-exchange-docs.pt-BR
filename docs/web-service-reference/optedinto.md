...
O elemento **OptedInto** Especifica um valor Boolean que indica se o usuário aceitos para a política de retenção. 
...
Um valor de texto de **true** para o elemento **OptedInto** indica que o usuário aceitos para a política de retenção. Um valor **false** indica que o usuário não consentir a política de retenção. 
