...
O elemento **CallbackPhones** especifica uma matriz de números de telefone de retorno de chamada e os identificadores de suas atribuições de origem para o persona associado. 
