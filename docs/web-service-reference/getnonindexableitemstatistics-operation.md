...
Encontre informações sobre a operação de EWS **GetNonIndexableItemStatistics** . 
...
A operação **GetNonIndexableItemStatistics** contagens de itens de caixa de correio que não podem ser indexados. Itens que não podem ser indexados não serão pesquisados durante uma pesquisa de descoberta. 
  
### <a name="getnonindexableitemstatistics-operation-soap-headers"></a>Cabeçalhos SOAP GetNonIndexableItemStatistics operação

A operação **GetNonIndexableItemStatistics** pode usar os cabeçalhos SOAP que estão listados na tabela a seguir. 
...
## <a name="getnonindexableitemstatistics-operation-request-example-get-the-count-of-items-that-cannot-be-indexed-in-a-mailbox"></a>Exemplo de solicitação de operação GetNonIndexableItemStatistics: obter contagem de itens que não podem ser indexados em uma caixa de correio
