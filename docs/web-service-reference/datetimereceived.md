...
O elemento **DateTimeReceived** representa a data e hora em que um item em uma caixa de correio foi recebido. 
...
O valor de texto representa a hora em que um item é recebido em uma caixa de correio. Esta propriedade é somente leitura.
