...
---
# <a name="fileextension-soap"></a>ExtensãoDeArquivo (SOAP)
...
|**Elemento**|**Descrição**|
|:-----|:-----|
|[SupportedFileExtensions (SOAP)](supportedfileextensions-soap.md) <br/> |Contém uma lista de extensões de arquivo em um local de compartilhamento de documentos.  <br/> |
   
## <a name="text-value"></a>Valor de texto

O valor de texto do elemento **ExtensãoDeArquivo** é uma extensão de arquivo válida para o local de compartilhamento de documentos. 
