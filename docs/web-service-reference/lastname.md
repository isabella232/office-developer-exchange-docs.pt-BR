...
---
# <a name="lastname"></a>Sobrenome

O elemento **LastName** representa o sobrenome de um contato. 
...
O valor de texto é uma cadeia de caracteres que representa o último nome de um contato.
