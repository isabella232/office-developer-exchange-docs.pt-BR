...
---
# <a name="mailboxes-arrayofstringstype"></a>Caixas de correio (ArrayOfStringsType)

O elemento de **caixas de correio** contém uma lista de caixas de correio afetadas pela retenção. 
