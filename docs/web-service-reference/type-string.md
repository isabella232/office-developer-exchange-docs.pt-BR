...
---
# <a name="type-string"></a>Tipo (string)

O **tipo** de elemento Especifica o tipo de endereço postal ou número de telefone, "por exemplo, casa" ou "Negócios". 
...
O valor de texto do elemento **Type** é o tipo de um endereço postal ou número de telefone. Por exemplo, os valores "Casa" ou "Corporativos" são valores esperados para o **tipo** de elemento. 
