...
description: O elemento ImageBase64 (SetEncryptionConfigurationType) destina-se apenas ao uso interno.
...
O **elemento ImageBase64 (SetEncryptionConfigurationType)** destina-se apenas ao uso interno. 
