...
---
# <a name="messagetrackingreportid"></a>Messagetrackingreportid deve ser passado

O elemento **messagetrackingreportid deve ser passado** representa a mensagem por sua ID de mensagem, a organização onde a mensagem foi encontrada, o servidor no qual a mensagem foi enviada e uma ID interna que identifica exclusivamente a mensagem. 
