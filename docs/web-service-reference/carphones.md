...
O elemento de **telefone do carro** Especifica uma matriz de números de telefone de carro e os identificadores de suas atribuições de origem para a pessoa associada. 
