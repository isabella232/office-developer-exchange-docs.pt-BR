...
---
# <a name="name-attachmenttype"></a>Nome (AttachmentType)

O elemento **Name** representa o nome do anexo. 
...
O valor de texto é um valor string que representa o nome do anexo.
