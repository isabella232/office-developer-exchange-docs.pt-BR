...
Saiba como obter informações de disponibilidade e tempos de reunião sugeridos usando a API gerenciada do EWS ou o EWS no Exchange.
  
O uso da API gerenciada do EWS ou do EWS para criar programaticamente [uma reunião](how-to-create-appointments-and-meetings-by-using-ews-in-exchange-2013.md) e enviar solicitações de reunião é ótimo, mas encontrar um horário que funcione para todos os seus participantes é geralmente um desafio. Se você tiver que verificar manualmente quando todos estão disponíveis, ele anulará a finalidade de automatizar a tarefa. Felizmente, o método de API gerenciada do EWS do [ExchangeService. GetUserAvailability](https://msdn.microsoft.com/library/microsoft.exchange.webservices.data.exchangeservice.getuseravailability%28v=exchg.80%29.aspx) e a operação [GetUserAvailability](https://msdn.microsoft.com/library/7906711b-80a1-42ae-8b33-26eeac036a5a%28Office.15%29.aspx) EWS chegam à sua resgate. Você pode usar esse método ou operação para consultar um servidor do Exchange para encontrar o melhor momento para agendar uma reunião ou apenas obter informações de disponibilidade para os participantes. Você pode obter as informações de disponibilidade de uma lista de participantes ou fazer com que seu servidor do Exchange encontre um horário de reunião ou ambos 
  
A Figura 1 ilustra o problema e a solução.
  
**Figura 1. Solicitando informações de disponibilidade de um servidor Exchange**
...
## <a name="get-suggested-meeting-times-and-freebusy-information-by-using-the-ews-managed-api"></a>Obter horários de reunião e informações de disponibilidade sugeridas usando a API gerenciada do EWS
<a name="bk_getavailewsma"> </a>

Você pode obter uma lista de horários de reunião sugeridos e todos os horários de evento agendados para seus participantes quando usa um valor de enumeração [AvailabilityData](https://msdn.microsoft.com/library/office/microsoft.exchange.webservices.data.availabilitydata%28v=exchg.80%29.aspx) de **FreeBusyAndSuggestions** na chamada do método [ExchangeService. GetUserAvailability](https://msdn.microsoft.com/library/microsoft.exchange.webservices.data.exchangeservice.getuseravailability%28v=exchg.80%29.aspx) , conforme mostrado no exemplo a seguir. 
...
## <a name="get-suggested-meeting-times-and-freebusy-information-by-using-ews"></a>Obter horários de reunião e informações de disponibilidade sugeridas usando o EWS
<a name="bk_getavailews"> </a>

Você pode obter uma lista de horários de reunião sugeridos e todos os horários de eventos agendados para seus participantes usando a operação [GetUserAvailability](https://msdn.microsoft.com/library/7906711b-80a1-42ae-8b33-26eeac036a5a%28Office.15%29.aspx) , conforme mostrado no exemplo a seguir. Essa é também a solicitação XML que a API gerenciada do EWS envia quando você usa a API gerenciada do EWS para [obter tempos de reunião sugeridos](#bk_getavailewsma).
...
O servidor responde à [solicitação GetUserAvailability](https://msdn.microsoft.com/library/7906711b-80a1-42ae-8b33-26eeac036a5a%28Office.15%29.aspx) com uma mensagem de [resposta GetUserAvailability](https://msdn.microsoft.com/library/6999510a-d60e-43da-8964-57b5fb3e9d11%28Office.15%29.aspx) , conforme mostrado no exemplo a seguir. 
