...
|:-----|:-----|:-----|
|<span data-ttu-id="cb5f8-115">Ocultar uma pasta</span><span class="sxs-lookup"><span data-stu-id="cb5f8-115">Hide a folder</span></span>  <br/> |<span data-ttu-id="cb5f8-116">[Folder.Bind](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.folder.bind%28v=exchg.80%29.aspx) seguido [Folder.Update](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.folder.update%28v=exchg.80%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="cb5f8-116">[Folder.Bind](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.folder.bind%28v=exchg.80%29.aspx) followed by [Folder.Update](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.folder.update%28v=exchg.80%29.aspx)</span></span> <br/> |<span data-ttu-id="cb5f8-117">[GetFolder](http://msdn.microsoft.com/library/355bcf93-dc71-4493-b177-622afac5fdb9%28Office.15%29.aspx) seguido [UpdateFolder](http://msdn.microsoft.com/library/3494c996-b834-4813-b1ca-d99642d8b4e7%28Office.15%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="cb5f8-117">[GetFolder](http://msdn.microsoft.com/library/355bcf93-dc71-4493-b177-622afac5fdb9%28Office.15%29.aspx) followed by [UpdateFolder](http://msdn.microsoft.com/library/3494c996-b834-4813-b1ca-d99642d8b4e7%28Office.15%29.aspx)</span></span> <br/> |
|<span data-ttu-id="cb5f8-118">Localizar pastas ocultas</span><span class="sxs-lookup"><span data-stu-id="cb5f8-118">Find hidden folders</span></span>  <br/> |[<span data-ttu-id="cb5f8-119">FindFolders</span><span class="sxs-lookup"><span data-stu-id="cb5f8-119">FindFolders</span></span>](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.exchangeservice.findfolders%28v=exchg.80%29.aspx) <br/> |[<span data-ttu-id="cb5f8-120">FindFolder</span><span class="sxs-lookup"><span data-stu-id="cb5f8-120">FindFolder</span></span>](http://msdn.microsoft.com/library/7a9855aa-06cc-45ba-ad2a-645c15b7d031%28Office.15%29.aspx) <br/> |
   
<span data-ttu-id="cb5f8-121">Você gostaria da única exceção é — ou seja, a pasta na raiz em que é visível para os usuários?</span><span class="sxs-lookup"><span data-stu-id="cb5f8-121">Are you wondering what the one exception is — that is, what folder in the root IS visible to users?</span></span> <span data-ttu-id="cb5f8-122">É a pasta Finder (também conhecido como o valor de enumeração **SearchFolders**[WellKnownFolder](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.wellknownfoldername%28v=exchg.80%29.aspx) , ou o valor do elemento **searchfolders**[DistinguishedFolderId](http://msdn.microsoft.com/library/50018162-2941-4227-8a5b-d6b4686bb32f%28Office.15%29.aspx) ), que contém as pastas de pesquisa dos usuários.</span><span class="sxs-lookup"><span data-stu-id="cb5f8-122">It's the Finder folder (also known as the **SearchFolders**[WellKnownFolder](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.wellknownfoldername%28v=exchg.80%29.aspx) enumeration value, or the **searchfolders**[DistinguishedFolderId](http://msdn.microsoft.com/library/50018162-2941-4227-8a5b-d6b4686bb32f%28Office.15%29.aspx) element value), which contains users' search folders.</span></span> <span data-ttu-id="cb5f8-123">Pastas de pesquisa criadas na pasta Finder estarão visíveis para os usuários do Outlook.</span><span class="sxs-lookup"><span data-stu-id="cb5f8-123">Search folders created in the Finder folder are visible to Outlook users.</span></span> <span data-ttu-id="cb5f8-124">Se você precisar criar uma pasta de pesquisa que não é visível para os usuários, movê-la sob a pasta raiz de ocultá-lo.</span><span class="sxs-lookup"><span data-stu-id="cb5f8-124">If you need to create a search folder that is not visible to users, move it under the root folder to hide it.</span></span> <span data-ttu-id="cb5f8-125">Diferentemente de outras pastas, definindo a propriedade **PidTagAttributeHidden** como **true** não ocultará uma pasta de pesquisa na pasta Finder.</span><span class="sxs-lookup"><span data-stu-id="cb5f8-125">Unlike for other folders, setting the **PidTagAttributeHidden** property to **true** will not hide a search folder in the Finder folder.</span></span> 
...
<span data-ttu-id="cb5f8-128">Você pode [tornar uma pasta existente](how-to-work-with-folders-by-using-ews-in-exchange.md#bk_createfolderewsma) uma pasta oculta, alterando o [PidTagAttributeHidden](http://msdn.microsoft.com/pt-br/library/cc433490%28v=exchg.80%29.aspx) estendido a propriedade como **true**.</span><span class="sxs-lookup"><span data-stu-id="cb5f8-128">You can [make an existing folder](how-to-work-with-folders-by-using-ews-in-exchange.md#bk_createfolderewsma) a hidden folder by changing the [PidTagAttributeHidden](http://msdn.microsoft.com/pt-br/library/cc433490%28v=exchg.80%29.aspx) extended property to **true**.</span></span> <span data-ttu-id="cb5f8-129">Primeiro, crie uma [definição de propriedade estendida para a propriedade](properties-and-extended-properties-in-ews-in-exchange.md).</span><span class="sxs-lookup"><span data-stu-id="cb5f8-129">First, create an [extended property definition for the property](properties-and-extended-properties-in-ews-in-exchange.md).</span></span> <span data-ttu-id="cb5f8-130">Em seguida, use o método de [ligar](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.folder.bind%28v=exchg.80%29.aspx) para acessar a pasta e atualizar o valor da propriedade **PidTagAttributeHidden** como true e use o método [Update](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.folder.update%28v=exchg.80%29.aspx) para salvar as alterações.</span><span class="sxs-lookup"><span data-stu-id="cb5f8-130">Next, use the [Bind](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.folder.bind%28v=exchg.80%29.aspx) method to get to the folder, then update the value of the **PidTagAttributeHidden** property to true, and use the [Update](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.folder.update%28v=exchg.80%29.aspx) method to save the changes.</span></span> 
  
<span data-ttu-id="cb5f8-131">Este exemplo pressupõe que esse **serviço** é um válido [ExchangeService](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.exchangeservice%28v=exchg.80%29.aspx) do objeto para o proprietário da caixa de correio, que o usuário foi autenticado com um servidor Exchange e que **folderId** é um [Folder.Id](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.folder.id%28v=exchg.80%29.aspx) válido que identifica a pasta para ocultar.</span><span class="sxs-lookup"><span data-stu-id="cb5f8-131">This example assumes that **service** is a valid [ExchangeService](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.exchangeservice%28v=exchg.80%29.aspx) object for the mailbox owner, that the user has been authenticated to an Exchange server, and that **folderId** is a valid [Folder.Id](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.folder.id%28v=exchg.80%29.aspx) that identifies the folder to hide.</span></span> 
...
<span data-ttu-id="cb5f8-147">Você pode encontrar todas as pastas ocultas em uma pasta pai criando uma [definição de propriedade estendida](properties-and-extended-properties-in-ews-in-exchange.md) para **PidTagAttributeHidden** propriedade estendida e, em seguida, usando o método [FindFolders](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.exchangeservice.findfolders%28v=exchg.80%29.aspx) para localizar pastas com um ** PidTagAttributeHidden** valor é definido como **true**.</span><span class="sxs-lookup"><span data-stu-id="cb5f8-147">You can find all hidden folders under a parent folder by creating an [extended property definition](properties-and-extended-properties-in-ews-in-exchange.md) for the **PidTagAttributeHidden** extended property, and then using the [FindFolders](http://msdn.microsoft.com/pt-br/library/microsoft.exchange.webservices.data.exchangeservice.findfolders%28v=exchg.80%29.aspx) method to find folders with a **PidTagAttributeHidden** value that is set to **true**.</span></span> <span data-ttu-id="cb5f8-148">Este exemplo usa o MsgFolderRoot, também conhecida como a parte superior do armazenamento de informações ou subárvore IPM, como a pasta pai para pesquisar em.</span><span class="sxs-lookup"><span data-stu-id="cb5f8-148">This example uses the MsgFolderRoot, also known as the Top of Information Store, or IPM Subtree, as the parent folder to search under.</span></span>
